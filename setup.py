...
setup(
  name = 'Topsis-Shivank-102303655',         # How you named your package folder (MyLib)
  packages = ['Topsis-Shivank-102303655'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Library designed to input data, weights and impacts through command line, and generate rankings.',   # Give a short description about your library
